...
class ComicsSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        // for each per la generazione dello slug dal titolo
    ...
    {
        // Genera uno slug di base
        $slug = Str::slug($title, '-');
        $original_slug = $slug;

        //   verifichiamo l esistenza dello slug nel data

        $exist = Comic::where('slug', $slug)->first();
        $counter = 1;

        // cicliamo con while per generare uno slug univoco in caso di duplicati
